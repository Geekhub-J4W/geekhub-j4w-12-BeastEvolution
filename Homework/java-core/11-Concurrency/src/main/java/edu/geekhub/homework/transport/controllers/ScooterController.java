...
public class ScooterController implements VehicleController {
    ...
    public ScooterController(Car car, Track track, TrackMap trackMap, LocationService locationService) {
        this.car = car;
        this.track = track;
